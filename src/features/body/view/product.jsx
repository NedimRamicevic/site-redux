...
function Product({ product }) {
  ...
  function selectedproductOption(tab) {
    setproductOption(tab);
  };
        ...
        <div className="product-list w-1/4 max-h-min text-center mt-12 mb-14">
            <ul className=" bg-white rounded-xl w-2/3 h-fit m-auto py-1 shadow-md shadow-black ">
                {product.map((product,index) => (
                    ...
                    <li className={`border rounded-xl py-2 shadow-md shadow-white hover:bg-cyan-500 hover:text-white ${productOption === index ? "bg-cyan-500" : ""} `}  onClick={e => selectedproductOption(index)} >
